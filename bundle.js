...
`;var kt=.8,wn=250,vn=1,mn=.118,Dn=1,yn=ee(315/(64*Math.PI*Math.pow(We,9))),Pn=ee(-45/(Math.PI*Math.pow(We,6))),Sn=ee(45/(Math.PI*Math.pow(We,6))),ot=`
